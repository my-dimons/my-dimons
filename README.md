...
I'm a programmer on the [Esquimalt Atom Smashers's](https://github.com/Esquimalt-Atom-Smashers) FRC team `7287`.

### FTC DECODE || 2025-2026 || FRC REBUILT

I moved to team `7287` as a programmer.

### FTC INTO-THE-DEEP || 2024-2025 || FRC REEFSCAPE

I tried to start as a FTC programmer on team `20025`, but moved to the drive team as the **operator**. We made it past Qualifiers, but didn't get past Provincials. 
...
Theme: A modified verision of [monokai-spectrum](https://marketplace.visualstudio.com/items?itemName=KristofferHopland.MonokaiTheme) as my visual studio theme: [try it here!](https://github.com/my-dimons/Dimo) <br>
Font: [Cascadia Code](https://github.com/microsoft/cascadia-code/wiki/Installing-Cascadia-Code)
### Visual Studio Code
Theme: [Monokai Spectrum](https://marketplace.visualstudio.com/items?itemName=monokai.theme-monokai-pro-vscode) <br>
